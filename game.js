...
// Adding event listener for key presses.
...
// Determining random spawn location on grid.
function spawnLocation() {

    // Breaking entire canvas into grid of tiles.
...
class Snake {
    ...
    // Changing direction of movement of the snake.
    dir(dirX, dirY) {
    ...
    // Determining if snake has eaten a piece of food.
    eat() {
...
function init() {
    ...
    // Dynamically controlling size of canvas.
    ...
    food = new Food(spawnLocation(), "DeepPink");

}

// Updating position and redrawing of game objects.
function update() {
